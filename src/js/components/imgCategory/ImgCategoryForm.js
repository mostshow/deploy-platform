...
class ImgCategoryForm extends Component {
    constructor(props){
        super(props)
    ...
    onSubmit(e) {
        e.preventDefault();
        let { isEdit, toEditData, loadCreateImgCategory, loadEditImgCategory, form} = this.props;
        this.props.form.validateFieldsAndScroll((err, values) => {
            if (!err) {
                if(isEdit){
                    ...
                    loadEditImgCategory(params);
                }else{
                    loadCreateImgCategory(values);
                    form.setFieldsValue({
                        name: '',
                    });
                }
...
ImgCategoryForm.propTypes = {

}
export default Form.create()(ImgCategoryForm)
